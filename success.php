        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item mx-0 mx-lg-1">
                    <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="user.php">Order</a>
...
<div align="center"><b align="center" >Your order is on it's way!</b>  </div><br>
<img class="img-fluid mb-5 d-block mx-auto" src="img/19973.svg" alt="">
